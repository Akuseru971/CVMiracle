  ...
  return (
    <section className="bg-cloud py-12" aria-label="特集">
      <Reveal className="px-6">
        <p className="label-track text-[10px] font-medium text-graphite">WMF HIGHLIGHTS</p>
          ...
          <article key={slide.id} className="snap-start w-[calc(100%-1rem)] shrink-0 pr-4">
            <div className="relative h-[420px] w-full overflow-hidden bg-mist">
              ...
              <div className="absolute inset-x-0 bottom-0 p-6">
                ...
                <p className="mt-2 max-w-[300px] text-[12.5px] leading-relaxed text-paper/85">
                  {slide.body}
                </p>
                <button className="press mt-5 h-11 border border-paper/70 bg-paper/10 px-6 text-[12.5px] font-medium tracking-wide text-paper backdrop-blur-sm">
                  {slide.cta}
                </button>
              </div>
            </div>
